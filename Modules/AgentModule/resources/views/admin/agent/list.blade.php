...
@section('page_title', 'Admin agents list')
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card-header border-bottom-0 float-end">
                            <a href="{{ route('admin.agent.create') }}" class="btn btn-primary mb-4">Add new <i
                ...
                <div class="e-table px-5 pb-5">
                    <div class="table-responsive table-lg">
                        <table class="table border-top table-bordered mb-0">
                            ...
                            <tbody>
                                @include('agentmodule::admin.agent.partials._table-rows', [
                                    'items' => $agents,
                                ])
                            </tbody>
                        </table>
