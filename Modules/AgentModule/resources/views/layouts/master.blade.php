...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            {{-- header --}}
            @include('agentmodule::layouts.partials._header')
            {{-- header --}}

            {{-- sidebar --}}
            @include('agentmodule::layouts.partials._sidebar')
            {{-- sidebar --}}
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        All Rights Reserved by DebuggersLab. Designed and Developed by <a href="/">us</a>.
                    </div>
                </div>
            </div>
        </footer>
