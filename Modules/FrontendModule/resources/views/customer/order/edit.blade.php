...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="banner-heading">
                    <h1 class="banner-title" style="color: #ff9800">Order edit</h1>
                </div>
            </div><!-- Col end -->
        </div><!-- Row end -->
    </div><!-- Container end -->
    <div class="container mt-4">
        <div class="row">
            ...
            <form action="{{ route('customer.order-update', $order->id) }}" method="POST" id="address-form"
                                        ...
                                        <select name="location_id" id="location_id" class="form-control">
                                            ...
                                            @foreach ($locations as $location)
                                                <option value="{{ $location['id'] }}"
                                                    {{ $order->location_id === $location->id ? 'selected' : '' }}>
                                                    {{ $location['area_name'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="trash_weight" id="trash_weight"
                                            value="{{ $order->trash_weight }}" placeholder="Enter weight in kg (ex:12)">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="customer_note_1"
                                            value="{{ $order->customer_note_1 }}" id="customer_note_1"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="available_date"
                                            value="{{ $order->available_date }}" id="available_date"
                                            placeholder="Enter your note">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" name="available_time"
                                            value="{{ $order->available_time }}" id="available_time"
                                            placeholder="Enter your note">
                                    </div>
                                </div>
                            </div>
